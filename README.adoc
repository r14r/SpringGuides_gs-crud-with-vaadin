...
Data JPA and H2 dependencies. (You will add the Vaadin dependency later.)
...
./../../src/spring-guides/gs-crud-with-vaadin/blob/master/complete/build.gradle[`build.gradle` build file for an example of how to accomplish the same thing].
